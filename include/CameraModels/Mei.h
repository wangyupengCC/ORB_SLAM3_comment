...
#ifndef CAMERAMODELS_MEI_H
#define CAMERAMODELS_MEI_H
...
namespace ORB_SLAM3 {
    class MEI : public GeometricCamera {
    ...
    public:
        MEI() : precision(1e-6) {
            ...
            mnId=nNextId++;
            mnType = CAM_FISHEYE_MEI;
        }
        MEI(const std::vector<float> _vParameters) : GeometricCamera(_vParameters), precision(1e-6), mvLappingArea(2,0) ,tvr(nullptr) {
